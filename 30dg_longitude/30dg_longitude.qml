...
<qgis readOnly="1" version="3.16.1-Hannover" simplifyMaxScale="1" simplifyDrawingHints="0" labelsEnabled="1" styleCategories="AllStyleCategories" minScale="0" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0">
  <flags>
  ...
  <renderer-v2 forceraster="0" type="singleSymbol" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol force_rhr="0" type="line" name="0" clip_to_extent="1" alpha="0.5">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeUnit="Point" allowHtml="0" fontUnderline="0" blendMode="0" fontWordSpacing="0" fontLetterSpacing="0" textColor="0,0,0,255" fontWeight="50" fontItalic="0" fieldName="Longitude" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontFamily="Calibri" previewBkgrdColor="255,255,255,255" capitalization="0" textOpacity="1" namedStyle="Normal" fontSize="10" multilineHeight="1" isExpression="0" fontKerning="1" textOrientation="horizontal">
        <text-buffer bufferSize="1" bufferSizeUnits="MM" bufferNoFill="0" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="0.5" bufferBlendMode="0" bufferDraw="1" bufferColor="255,255,255,255"/>
      ...
      <rendering obstacleFactor="1" scaleMax="10000000" maxNumLabels="2000" obstacleType="0" labelPerPart="0" obstacle="1" mergeLines="0" fontLimitPixelSize="0" upsidedownLabels="0" minFeatureSize="0" drawLabels="1" zIndex="0" scaleVisibility="0" fontMaxPixelSize="10000" displayAll="0" scaleMin="1" limitNumLabels="0" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <DiagramLayerSettings obstacle="0" priority="0" dist="0" placement="2" zIndex="0" showAll="1" linePlacementFlags="2">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option type="Map" name="properties">
          <Option type="Map" name="positionX">
            ...
            <Option value="Longitude" type="QString" name="field"/>
  ...
  <aliases>
    <alias index="0" name="" field="Longitude"/>
  </aliases>
  <defaults>
  ...
  <expressionfields/>
  <attributeactions>
    <actionsetting shortTitle="" type="0" icon="" action="" id="{b6e93082-c4ff-4b6a-b2bc-4a048ec7c48f}" name="" notificationMessage="" isEnabledOnlyWhenEditable="0" capture="0">
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>display</previewExpression>
  <mapTip>display</mapTip>
